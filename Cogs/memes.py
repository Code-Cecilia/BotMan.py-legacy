...
from assets import aiohttp_assets
...
class Memes(commands.Cog):
    ...
    async def on_ready(self):
        result = json.loads(await aiohttp_assets.aiohttp_get("https://api.imgflip.com/get_memes"))
    ...
    async def meme_gen(self, ctx, meme_id, *text):
        ...
        result = json.loads(await aiohttp_assets.aiohttp_post("https://api.imgflip.com/caption_image", data=payload))
        if result["success"] is not True:
